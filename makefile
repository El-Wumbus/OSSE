...
build: clean
	mkdir -p dist
	i686-elf-g++ -c src/kernel/strlib/strcmp.c -o src/kernel/strlib/strcmp.o -ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti
	...
	i686-elf-g++ -T src/boot/linker.ld -o decatorOS.bin -ffreestanding -O2 -nostdlib src/boot/boot.o src/kernel/kernel.o src/kernel/strlib/strcmp.o -lgcc
...
clean:
	rm -fr src/kernel/kernel.o src/boot/boot.o decatorOS.bin decatorOS.iso dist src/kernel/strlib/strcmp.o
